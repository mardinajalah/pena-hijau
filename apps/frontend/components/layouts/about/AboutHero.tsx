...
const AboutHero = () => {
  return (
    <section className='relative flex min-h-[60vh] w-full items-center justify-center overflow-hidden pt-20'>
      <Image
      ...
      <div className='relative mx-auto w-full max-w-7xl px-5 py-20 sm:px-6 lg:px-8 text-center sm:text-left'>
        {/* Breadcrumb */}
